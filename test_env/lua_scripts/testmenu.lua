_editor_name = "Bringer of Worlds"

print("Making frame")
local mainframe = EWS:Frame("EWS Main Frame", Vector3(700, 100, 0), Vector3(1080, 800, 0),
  "CAPTION,CLOSE_BOX,MINIMIZE_BOX,MAXIMIZE_BOX,SYSTEM_MENU,RESIZE_BORDER", nil)
  --"CAPTION,CLOSE_BOX,MINIMIZE_BOX,MAXIMIZE_BOX,MAXIMIZE,SYSTEM_MENU,RESIZE_BORDER", nil)

print("Setting frame to visible")
